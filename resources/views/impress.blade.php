...
<head>
    ...
    -->
    <link href="{{ asset('css/impress.css') }}" rel="stylesheet"/>
...
<div class="fallback-message">
    <p>你的浏览器 <b>不支持此效果</b> </p>
    <p>请尝试使用<b>Chrome</b>, <b>Safari</b> or <b>Firefox</b> browser.</p>
</div>
...
-->
<script src="{{ asset('js/impress.js') }}"></script>
